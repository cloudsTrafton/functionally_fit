...
}catch (e30732){var _e__28311__auto__ = e30732;
return false;
...
}catch (e30734){var _e__28311__auto__ = e30734;
return false;
...
}catch (e30742){var _e__28311__auto__ = e30742;
return false;
...
}catch (e30746){var _e__28311__auto__ = e30746;
return false;
...
}catch (e30755){var _e__28311__auto__ = e30755;
return false;
}})())){
...
}catch (e30757){var _e__28311__auto__ = e30757;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__30762 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30763 = (function (){var or__4126__auto__ = config;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30763);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30762);
}});
});
...
return (function() { 
var G__30793__delegate = function (args){
...
while (G__30794__i < G__30794__a.length) {G__30794__a[G__30794__i] = arguments[G__30794__i + 0]; ++G__30794__i;}
  args = new cljs.core.IndexedSeq(G__30794__a,0,null);
} 
return G__30793__delegate.call(this,args);};
G__30793.cljs$lang$maxFixedArity = 0;
G__30793.cljs$lang$applyTo = (function (arglist__30795){
var args = cljs.core.seq(arglist__30795);
return G__30793__delegate(args);
});
