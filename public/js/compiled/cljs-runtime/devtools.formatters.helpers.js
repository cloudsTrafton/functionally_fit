...
var G__28905 = devtools.prefs.pref(v);
v = G__28905;
continue;
} else {
return v;
...
}catch (e28821){var _e__28311__auto__ = e28821;
return false;
}})();
...
}catch (e28827){var _e__28311__auto__ = e28827;
return false;
}})();
...
}catch (e28838){var _e__28311__auto__ = e28838;
return false;
}}
}
});
...
var vec__28881 = devtools.munging.parse_constructor_info(constructor_fn);
...
return cljs.core.some((function (p1__28889_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28889_SHARP_);
}),template);
});
