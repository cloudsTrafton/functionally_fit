...
if((i < len)){
var k = (ks[i]);
var G__38205 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__38206 = (i + (1));
m = G__38205;
i = G__38206;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38030 = c;
var G__38030__$1 = (((G__38030 == null))?null:G__38030.prototype);
if((G__38030__$1 == null)){
return null;
} else {
return (G__38030__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38041 = c;
var G__38041__$1 = (((G__38041 == null))?null:G__38041.prototype);
if((G__38041__$1 == null)){
return null;
} else {
return (G__38041__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__38231__delegate = function (args){
var G__38079 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__38079) : reagent.impl.component.as_element.call(null,G__38079));
};
var G__38231 = function (var_args){
var args = null;
...
while (G__38232__i < G__38232__a.length) {G__38232__a[G__38232__i] = arguments[G__38232__i + 0]; ++G__38232__i;}
  args = new cljs.core.IndexedSeq(G__38232__a,0,null);
} 
return G__38231__delegate.call(this,args);};
G__38231.cljs$lang$maxFixedArity = 0;
G__38231.cljs$lang$applyTo = (function (arglist__38233){
var args = cljs.core.seq(arglist__38233);
return G__38231__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__38081 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38082 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38082);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38081);
}});
...
var G__38087 = key;
var G__38087__$1 = (((G__38087 instanceof cljs.core.Keyword))?G__38087.fqn:null);
switch (G__38087__$1) {
...
var c = this;
var G__38113_38282 = (c["cljsRatom"]);
if((G__38113_38282 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38113_38282);
}
...
var renders_38303 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_38304 = cljs.core.first(cljs.core.vals(renders_38303));
if((cljs.core.count(renders_38303) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38303))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38304)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38304], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__38161 = name;
switch (G__38161) {
case "":
...
var name = (function (){var G__38178 = fiber;
var G__38178__$1 = (((G__38178 == null))?null:(G__38178["type"]));
if((G__38178__$1 == null)){
return null;
} else {
return (G__38178__$1["displayName"]);
}
})();
var parent = (function (){var G__38179 = fiber;
if((G__38179 == null)){
return null;
} else {
return (G__38179["return"]);
}
})();
var path = (function (){var G__38180 = parent;
var G__38180__$1 = (((G__38180 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__38180) : reagent.impl.component.fiber_component_path.call(null,G__38180)));
if((G__38180__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38180__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var G__38181 = c;
if((G__38181 == null)){
return null;
} else {
return (G__38181["_reactInternalFiber"]);
}
})();
...
var elem = (function (){var G__38185 = (function (){var or__4126__auto__ = (function (){var G__38187 = c;
if((G__38187 == null)){
return null;
} else {
return (G__38187["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
return (G__38185["_currentElement"]);
}
})();
var name = (function (){var G__38188 = elem;
var G__38188__$1 = (((G__38188 == null))?null:(G__38188["type"]));
if((G__38188__$1 == null)){
return null;
} else {
return (G__38188__$1["displayName"]);
}
})();
var path = (function (){var G__38189 = elem;
var G__38189__$1 = (((G__38189 == null))?null:(G__38189["_owner"]));
var G__38189__$2 = (((G__38189__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__38189__$1) : reagent.impl.component.component_path.call(null,G__38189__$1)));
if((G__38189__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38189__$2)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__38193 = c;
var G__38193__$1 = (((G__38193 == null))?null:G__38193.constructor);
if((G__38193__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__38193__$1);
}
}
})();
