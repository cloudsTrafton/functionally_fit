...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_31250 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_31250(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_31251 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_31251(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_31256 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_31256(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_31260 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_31260(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_31261 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_31261(reader);
}
});
...
var G__31340 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__31341 = s.append(c);
c = G__31340;
s = G__31341;
continue;
}
