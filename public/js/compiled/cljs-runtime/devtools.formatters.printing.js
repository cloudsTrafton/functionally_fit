...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28908){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28909,G__28910,seq28908__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28925_SHARP_){
return (!((cljs.core.meta(p1__28925_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28944__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28958){var _e__28311__auto__ = e28958;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e28960){var _e__28311__auto__ = e28960;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28962 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28963 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28963);

try{var map__28964 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28964__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28962);
}});
...
var temp__5733__auto___29019 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___29019)){
var managed_print_level_29020 = temp__5733__auto___29019;
var _STAR_print_level_STAR__orig_val__28968_29021 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28969_29022 = managed_print_level_29020;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28969_29022);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28967_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28967_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28968_29021);
}} else {
job_fn();
}
