...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28424__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28424__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28424__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e28423){var _e = e28423;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___28450 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___28450)){
var seen_errors_28451 = temp__5733__auto___28450;
if(cljs.core.truth_(seen_errors_28451.has(self))){
} else {
seen_errors_28451.add(self);

var temp__5735__auto___28452 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___28452)){
var sense_28453 = temp__5735__auto___28452;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28453)].join(''));
} else {
}
}
} else {
