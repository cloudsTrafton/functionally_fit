...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__27325){
var vec__27328 = p__27325;
...
var clojure$data$EqualityPartition$equality_partition$dyn_27477 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_27477(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_27480 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_27480(a,b);
}
});
...
var fexpr__27451 = (function (){var G__27454 = clojure.data.equality_partition(a);
var G__27454__$1 = (((G__27454 instanceof cljs.core.Keyword))?G__27454.fqn:null);
switch (G__27454__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27454__$1)].join('')));

}
})();
return (fexpr__27451.cljs$core$IFn$_invoke$arity$2 ? fexpr__27451.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__27451.call(null,a,b));
}));
/**
