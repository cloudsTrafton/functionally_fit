...
var o42064 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42064["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42065 = temp__5733__auto____$1;
return (o42065["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28295__auto__ = f;
return (o__28295__auto__["toString"]).call(o__28295__auto__);
} else {
return "";
}
}catch (e42069){var _ = e42069;
return "";
}});
...
try{var o__28295__auto___42299 = t;
(o__28295__auto___42299["cljs$lang$ctorPrWriter"]).call(o__28295__auto___42299,t,writer);
}catch (e42074){var __42301 = e42074;
}
...
var char_code = (function (){var o__28295__auto__ = (new String(char$));
return (o__28295__auto__["charCodeAt"]).call(o__28295__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28295__auto__ = String;
return (o__28295__auto__["fromCharCode"]).call(o__28295__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42084 = num_code;
switch (G__42084) {
case (1):
return (185);
...
var o__28295__auto__ = String;
return (o__28295__auto__["fromCharCode"]).call(o__28295__auto__,superscript_code);
});
/**
...
}catch (e42085){var _e__28311__auto__ = e42085;
return false;
}})())){
...
var vec__42086 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42086,(0),null);
...
var temp__5733__auto____$1 = (o42092["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42093 = temp__5733__auto____$1;
return (o42093["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42103){
var vec__42104 = p__42103;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42104,(0),null);
...
var G__42320 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42321 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42320;
remaining_tokens = G__42321;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42100){
...
var vec__42118 = cljs.core.split_with((function (p1__42117_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42117_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42118,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42118,(1),null);
...
var vec__42126 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42126,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42126,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42325 = cljs.core.rest(remaining_tokens);
var G__42326 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42325;
name_tokens = G__42326;
continue;
} else {
...
var vec__42133 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42133,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42133,(1),null);
var vec__42136 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42136,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42136,(1),null);
var vec__42139 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42139,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42139,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42139,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42139,(3),null);
...
var vec__42150 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42150,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42150,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42150,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42150,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42150,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42150,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__42157 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42157,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42157,(1),null);
var vec__42160 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42160,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42160,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42170 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42170) : devtools.munging.parse_fn_info_deep.call(null,G__42170));
})()));
}
} else {
return fn_info;
...
var G__42342 = (arity + (1));
var G__42343 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42186){
var vec__42187 = p__42186;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42187,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42187,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42198_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42198_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42199_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42199_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___42353 = arguments.length;
var i__4737__auto___42354 = (0);
while(true){
if((i__4737__auto___42354 < len__4736__auto___42353)){
args__4742__auto__.push((arguments[i__4737__auto___42354]));

var G__42355 = (i__4737__auto___42354 + (1));
i__4737__auto___42354 = G__42355;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42205){
var vec__42206 = p__42205;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42206,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42202){
var G__42203 = cljs.core.first(seq42202);
var seq42202__$1 = cljs.core.next(seq42202);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42203,seq42202__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42228__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42228__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42228__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42228__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42229 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42229,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42229,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42229,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42229,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42229,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42229,(5),null);
...
var o__28295__auto__ = f;
return (o__28295__auto__["getBasis"]).call(o__28295__auto__);
});
/**
...
}catch (e42241){var _e__28311__auto__ = e42241;
...
var G__42364 = (obj[cljs.core.first(path)]);
var G__42365 = cljs.core.rest(path);
obj = G__42364;
path = G__42365;
continue;
} else {
...
var _STAR_ = (function (accum,p__42259){
var vec__42260 = p__42259;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42260,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42260,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42270){
var vec__42271 = p__42270;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42271,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42271,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42271,(2),null);
...
var post_process = (function (p__42280){
var vec__42281 = p__42280;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42281,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42281,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42276_SHARP_){
return (obj[cljs.core.first(p1__42276_SHARP_)]);
}),sorted_matches);
