...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__41442){
...
var vec__41457 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41457,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41457,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41457,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_41615 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_41615(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_41641 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_41641(a,b);
}
});
...
var fexpr__41585 = (function (){var G__41586 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41586__$1)].join('')));

}
})();
return (fexpr__41585.cljs$core$IFn$_invoke$arity$2 ? fexpr__41585.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__41585.call(null,a,b));
}));
/**
