...
var i_45447 = (0);
while(true){
if((i_45447 < arr.length)){
(arr[i_45447] = null);

var G__45449 = (i_45447 + (1));
i_45447 = G__45449;
continue;
} else {
}
...
var i_45463 = (self__.level + (1));
while(true){
if((i_45463 <= (new_level + (1)))){
(update[i_45463] = self__.header);

var G__45465 = (i_45463 + (1));
i_45463 = G__45465;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_45466 = (update[i]).forward;
(x__$2.forward[i] = (links_45466[i]));
...
if((x__$1 === (((i_45468 < links_45469.length))?(links_45469[i_45468]):null))){
...
if(cljs.core.truth_(nx)){
var G__45490 = nx;
var G__45491 = (level__$1 - (1));
x = G__45490;
level__$1 = G__45491;
continue;
} else {
var G__45493 = x;
var G__45494 = (level__$1 - (1));
x = G__45493;
level__$1 = G__45494;
continue;
}
