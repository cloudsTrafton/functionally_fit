...
var len__4736__auto___45691 = arguments.length;
var i__4737__auto___45693 = (0);
while(true){
if((i__4737__auto___45693 < len__4736__auto___45691)){
args_arr__4757__auto__.push((arguments[i__4737__auto___45693]));

var G__45695 = (i__4737__auto___45693 + (1));
i__4737__auto___45693 = G__45695;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq45613){
var G__45614 = cljs.core.first(seq45613);
var seq45613__$1 = cljs.core.next(seq45613);
var G__45615 = cljs.core.first(seq45613__$1);
var seq45613__$2 = cljs.core.next(seq45613__$1);
var G__45619 = cljs.core.first(seq45613__$2);
var seq45613__$3 = cljs.core.next(seq45613__$2);
var G__45620 = cljs.core.first(seq45613__$3);
var seq45613__$4 = cljs.core.next(seq45613__$3);
var G__45621 = cljs.core.first(seq45613__$4);
var seq45613__$5 = cljs.core.next(seq45613__$4);
var G__45622 = cljs.core.first(seq45613__$5);
var seq45613__$6 = cljs.core.next(seq45613__$5);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__45614,G__45615,G__45619,G__45620,G__45621,G__45622,seq45613__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__45654){
var vec__45663 = p__45654;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45663,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45663,(1),null);
