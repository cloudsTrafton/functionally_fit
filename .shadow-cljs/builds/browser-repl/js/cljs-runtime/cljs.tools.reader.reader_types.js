...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_44715 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_44715(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_44723 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_44723(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44724 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_44724(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44735 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_44735(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44746 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_44746(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44752 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_44752(reader);
}
});
...
var G__44849 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__44850 = s.append(c);
c = G__44849;
s = G__44850;
continue;
}
