...
var G__42357 = devtools.prefs.pref(v);
v = G__42357;
continue;
} else {
return v;
...
}catch (e42306){var _e__28311__auto__ = e42306;
return false;
}})();
...
}catch (e42318){var _e__28311__auto__ = e42318;
return false;
}})();
...
}catch (e42322){var _e__28311__auto__ = e42322;
return false;
}}
}
});
...
var vec__42336 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42336,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42336,(1),null);
...
return cljs.core.some((function (p1__42341_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42341_SHARP_);
}),template);
});
