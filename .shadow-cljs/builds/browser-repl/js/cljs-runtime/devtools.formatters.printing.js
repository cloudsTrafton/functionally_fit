...
var len__4736__auto___42392 = arguments.length;
var i__4737__auto___42393 = (0);
while(true){
if((i__4737__auto___42393 < len__4736__auto___42392)){
args__4742__auto__.push((arguments[i__4737__auto___42393]));

var G__42394 = (i__4737__auto___42393 + (1));
i__4737__auto___42393 = G__42394;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42361){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42362,G__42363,seq42361__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42367_SHARP_){
return (!((cljs.core.meta(p1__42367_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42370__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42375){var _e__28311__auto__ = e42375;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e42377){var _e__28311__auto__ = e42377;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42385 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42386 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42386);

try{var map__42387 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42387__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42385);
}});
...
var temp__5733__auto___42409 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42409)){
var managed_print_level_42410 = temp__5733__auto___42409;
var _STAR_print_level_STAR__orig_val__42390_42411 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42391_42412 = managed_print_level_42410;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42391_42412);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42389_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42389_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42390_42411);
}} else {
job_fn();
}
