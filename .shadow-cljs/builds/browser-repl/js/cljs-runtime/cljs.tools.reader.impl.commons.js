...
var G__44986 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__44986;
continue;
} else {
return ch;
...
var vec__44975 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44975,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq44980){
...
return (function() { 
var G__44996__delegate = function (rdr,_){
...
var G__44996 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__44997__i = 0, G__44997__a = new Array(arguments.length -  1);
while (G__44997__i < G__44997__a.length) {G__44997__a[G__44997__i] = arguments[G__44997__i + 1]; ++G__44997__i;}
  _ = new cljs.core.IndexedSeq(G__44997__a,0,null);
} 
return G__44996__delegate.call(this,rdr,_);};
G__44996.cljs$lang$maxFixedArity = 1;
G__44996.cljs$lang$applyTo = (function (arglist__44998){
var rdr = cljs.core.first(arglist__44998);
var _ = cljs.core.rest(arglist__44998);
return G__44996__delegate(rdr,_);
});
