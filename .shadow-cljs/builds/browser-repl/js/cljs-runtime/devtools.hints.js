...
}catch (e41996){var _e = e41996;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___42008 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___42008)){
var seen_errors_42009 = temp__5733__auto___42008;
if(cljs.core.truth_(seen_errors_42009.has(self))){
} else {
seen_errors_42009.add(self);

var temp__5735__auto___42010 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___42010)){
var sense_42011 = temp__5735__auto___42010;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_42011)].join(''));
} else {
}
}
} else {
